...
if(isset($_SESSION['username'])==true && $_SESSION['tipo']==2){             
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">SIIARU</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Inicia sesion con tu cuentaaaaaa</h5>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                        <button class="btn btn-primary w-100" type="submit" id = "registrate" >Identificate</button>
                    </div>
                  </form>
              ...
              <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">Sergio_cnp</a>
              </div>
